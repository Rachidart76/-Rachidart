const translations = {
  fr: {
    ...
    yearsValue: "30+",
    yearsLabel: "ans de parcours",
    rootsValue: "Tafilalet",
    rootsLabel: "racines musicales",
    cityValue: "Dakhla",
    cityLabel: "création & scène",
    instrumentLabel: "EN LIVE · OUD",
    heroPhotoAlt: "Rachid Haddaoui jouant du oud lors d’une performance musicale",
    signatureEyebrow: "INSTRUMENT",
    signatureName: "L’instrument de Rachid",
  ...
  ar: {
    ...
    yearsValue: "+30",
    yearsLabel: "سنة من المسار الفني",
    rootsValue: "تافيلالت",
    rootsLabel: "الجذور الموسيقية",
    cityValue: "الداخلة",
    cityLabel: "الإبداع والخشبة",
    instrumentLabel: "مباشر · عود",
    heroPhotoAlt: "رشيد حداوي يعزف على العود خلال أداء موسيقي",
    signatureEyebrow: "الآلة المميزة",
    signatureName: "آلة رشيد حداوي",
...
let activeType = "all";
let activeYear = "all";
let currentLanguage = localStorage.getItem("rachid-site-language") || "fr";
...
function applyLanguage(language) {
  ...
  document.querySelectorAll("[data-i18n]").forEach((element) => {
    ...
    if (locale[key]) element.innerHTML = locale[key];
  });
  ...
  langSwitch.setAttribute("aria-label", language === "ar" ? "Afficher le site en français" : "عرض الموقع بالعربية");
  localStorage.setItem("rachid-site-language", language);
}
...
function updateFilters() {
  ...
  workCards.forEach((card) => {
    ...
    const shouldShow = typeMatch && yearMatch;
